                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <form action="{{ url("/admin/logout") }}" method="post">
                            ...
                            <button value="1" name="btnReport" type="submit" class="btn btn-primary">Report Page</button>
                            <button value="1" name="btnListKaryawan" type="submit" class="btn btn-info">Master Karyawan</button>
                        </form>
                    </div>
                </div>
            </nav>
